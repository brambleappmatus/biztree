...
"[project]/Desktop/biztree/src/app/api/documents/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const documents = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.findMany({
            where: {
                profileId
            },
            orderBy: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(documents);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].profile.findFirst({
            where: {
                id: profileId,
        ...
        const existingCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.count({
            where: {
                profileId
            }
        });
        if (existingCount >= 6) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Maximum 6 documents allowed"
            }, {
                status: 400
            });
        }
        // Get the highest order number
        const lastDocument = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.findFirst({
            where: {
                profileId
            },
            orderBy: {
        ...
        const document = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.create({
            data: {
                name,
                url,
                fileType,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(document);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f8372d4._.js.map