...
"[project]/Desktop/biztree/src/app/api/analytics/time/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const pageView = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].pageView.findFirst({
            where: {
                profileId,
                visitorId,
                sessionId,
        ...
        if (pageView) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].pageView.update({
                where: {
                    id: pageView.id
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6bc27979._.js.map