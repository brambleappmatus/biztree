...
"[project]/Desktop/biztree/src/app/api/gallery/albums/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const albums = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].galleryAlbum.findMany({
            where: {
                profileId
            },
            include: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(albums);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        if (!name || !profileId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Name and Profile ID required"
            }, {
                status: 400
            });
        }
        ...
        // Get max order
        const lastAlbum = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].galleryAlbum.findFirst({
            where: {
                profileId
            },
            orderBy: {
        ...
        const album = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].galleryAlbum.create({
            data: {
                name,
                profileId,
                order: newOrder
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$biztree$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(album);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__701563fe._.js.map