...
const ONBOARDING_TRANSLATIONS = {
    ...
    cs: {
        ...
        subtitle: "Vyplňte základní informace a vytvořte si profesionální online profil",
        basicInfo: "Základní informace",
        companyName: "Název firmy / Jméno *",
        companyNameHelper: "Toto je název, který uvidí vaši zákazníci. Můžete ho kdykoli změnit.",
        subdomain: "Subdoména (URL adresa) *",
        subdomainHelper: "Toto bude vaše jedinečná webová adresa (např. vase-jmeno.biztree.bio). Po vytvoření ji už NELZE změnit, proto si ji dobře promyslete!",
        checking: "Kontroluji dostupnost...",
        available: "je dostupná",
        subdomainTaken: "Tato subdoména již existuje",
        subdomainWww: "Subdoména nemůže být 'www'",
        ...
        addressPlaceholder: "např. Hlavní 123, Praha",
        socialMedia: "Sociální sítě",
        socialMediaDesc: "Přidejte odkazy na vaše sociální sítě (volitelné)",
        openingHours: "Otevírací hodiny",
        openingHoursDesc: "Nastavte otevírací hodiny (volitelné)",
        open: "Otevřeno",
        days: ["Pondělí", "Úterý", "Středa", "Čtvrtek", "Pátek", "Sobota", "Neděle"],
        submit: "Dokončit a doplnit další",
        submitDesc: "Další detaily můžete přidat v admin panelu",
        livePreview: "Živý náhled",
        yourSubdomain: "vase-subdomena.biztree.bio",
        yourName: "Váš název",
        startFilling: "Začněte vyplňovat formulář",
        seePreview: "a uvidíte náhled zde",
        notLoggedIn: "Nejste přihlášen",
        fillRequired: "Vyplňte všechna povinná pole a vyberte dostupnou subdoménu",
        errorCreating: "Nastala chyba při vytváření profilu"
    }
};
